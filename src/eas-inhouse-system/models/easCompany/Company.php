...
/**
 * This is the model class for table "eas_company".
 *
 * @property string $id
 ...
 *
 * @property EasCompanyDivision[] $easCompanyDivisions
 * @property EasCompanyEmployee[] $easCompanyEmployees
 * @property EasCompanyProject[] $easCompanyProjects
 */
class Company extends \app\models\BaseBatsgModel
{
     ...
     */
    public function getEasCompanyDivisions()
    {
        return $this->hasMany(EasCompanyDivision::className(), ['company_id' => 'id']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getEasCompanyEmployees()
    {
        return $this->hasMany(EasCompanyEmployee::className(), ['company_id' => 'id']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getEasCompanyProjects()
    {
        return $this->hasMany(EasCompanyProject::className(), ['company_id' => 'id']);
    }
}
