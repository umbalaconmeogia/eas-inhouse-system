...
/**
 * Handles the creation of table `expenses_settlement_month`.
 */
class m161124_081502_create_expenses_settlement_month_table extends BaseMigrationCreateTable
{
    protected $table = 'expenses_settlement_month';
